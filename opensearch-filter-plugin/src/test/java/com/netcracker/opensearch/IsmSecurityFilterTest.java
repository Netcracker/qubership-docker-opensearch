...
import static com.netcracker.opensearch.Constants.ADD_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.CHANGE_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.DELETE_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.EXPLAIN_ACTION_NAME;
import static com.netcracker.opensearch.Constants.GET_POLICIES_ACTION_NAME;
import static com.netcracker.opensearch.Constants.GET_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.INDEX_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.REMOVE_POLICY_ACTION_NAME;
import static com.netcracker.opensearch.Constants.RETRY_FAILED_MANAGED_INDEX_ACTION_NAME;
...
public class IsmSecurityFilterTest {
  ...
  public void testAllowAddPolicyWithPermissibleNameAndIndices() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(ADD_POLICY_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowChangePolicyWithPermissibleNameAndIndices() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(CHANGE_POLICY_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testDeletePolicyWithPermissibleName() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(DELETE_POLICY_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowExplainIndexWithoutFilter() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(EXPLAIN_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowGetPolicyWithPermissibleName() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(GET_POLICY_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowGetPolicies() throws IOException {
    ActionRequest request = new TestsActionRequest();
    boolean isAllowed = filter.allowAction(GET_POLICIES_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowRemovePolicyFromIndexWithPermissibleName() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(REMOVE_POLICY_ACTION_NAME, request, RESOURCE_PREFIX);
  ...
  public void testAllowRetryFailedManagedIndexWithPermissibleName() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(RETRY_FAILED_MANAGED_INDEX_ACTION_NAME, request,
        RESOURCE_PREFIX);
  ...
  public void testAllowCreatePolicyWithPermissibleNameAndNoTemplate() throws IOException {
    ...
    boolean isAllowed = filter.allowAction(INDEX_POLICY_ACTION_NAME, actionRequest,
        RESOURCE_PREFIX);
